var form = '<form id="contactForm" action="/contact" method="post">' +
    ...
    '               <input name="name" type="text" class="text" value="Name *" onfocus="this.value = this.value === \'Name *\' ? \'\' : this.value" onblur="if (this.value == \'\') {this.value = \'Name *\';}">' +
    '               <input name="email" type="text" class="text" value="Email *" onfocus="this.value = this.value === \'Email *\' ? \'\' : this.value" onblur="if (this.value == \'\') {this.value = \'Email *\';}">' +
    '               <input name="phone" type="text" class="text" value="Phone *" onfocus="this.value = this.value === \'Phone *\' ? \'\' : this.value" onblur="if (this.value == \'\') {this.value = \'Phone *\';}">' +
    '           </div>' +
